...
<body>
         ...
         <div class="cards-grid">
            <?php if (count($lugares) > 0): ?>
               <?php foreach ($lugares as $lugar): ?>
                  <div class="card" onclick="openModal('igarape-<?php echo htmlspecialchars($lugar['id']); ?>')">
   ...
   <?php foreach ($lugares as $lugar): ?>
      <div id="modal-igarape-<?php echo htmlspecialchars($lugar['id']); ?>" class="modal">
         <div class="modal-box">
            <span class="close" onclick="closeModal('igarape-<?php echo htmlspecialchars($lugar['id']); ?>')">&times;</span>
            <div class="image-carousel">
               ...
               <button class="carousel-btn prev" onclick="prevImage('igarape-<?php echo htmlspecialchars($lugar['id']); ?>')">
                  < </button>
                     <button class="carousel-btn next" onclick="nextImage('igarape-<?php echo htmlspecialchars($lugar['id']); ?>')"> > </button>
